...
from app.config import configure_logging, IMAGE_MODEL_NAMES, ProxyPool, G_TOKEN, POPAI_BASE_URL, get_env_value
...
def get_gtoken():
    ...
    try:
        ...
        try:
            ...
            with open('gtoken.txt', 'w', encoding='utf-8', errors='ignore') as f:
                f.write(gtoken)
                f.write('\n')
        finally:
            driver.quit()  # 确保浏览器实例在异常情况下也能关闭
